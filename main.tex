...
We evaluate three model variants, the base pretrained model, the
supervised fine-tuned (SFT) model, and the RL post-trained model, by
comparing their ability to generate
...
entire canonical green fluorescent protein (GFP) expression cassette.
