...
\begin{itemize}
\item \textbf{Batch size:} [fill in]
\item \textbf{Learning rate:} [fill in] with [warmup schedule]
\item \textbf{Optimizer:} AdamW
\item \textbf{Epochs:} 3
\item \textbf{Gradient accumulation steps:} [fill in]
...
\item \textbf{GRPO group size:} [fill in]
